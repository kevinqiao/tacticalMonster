...
export function CasualPlatformProvider({ children }: { children: React.ReactNode }) {
  ...
  return (
    <CasualPlatformContext.Provider value={value}>{children}</CasualPlatformContext.Provider>
  );
}

export default CasualPlatformProvider;
