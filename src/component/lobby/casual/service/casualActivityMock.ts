...
export function getMockCasualActivitiesForUiDemo(): CasualActivityPublicRow[] {
  ...
  return [
    ...
    {
      activityId: "mock_ui_shop_replay_pass_gem_08",
      title: "再战令×3·钻石价 8 折（演示）",
      target: { type: "casual_shop_sku", shopSkuId: "shop_replay_pass_3pack" },
      seasonId: "casual_s1",
      startsAt,
      endsAt,
    ...
    {
      activityId: "mock_ui_shop_emote_gem_088",
      title: "表情包·钻石价 88 折（演示）",
      target: { type: "casual_shop_sku", shopSkuId: "shop_emote_pack_gems" },
      seasonId: "casual_s1",
      startsAt,
      endsAt,
    ...
    {
      activityId: "mock_ui_shop_flair_coin_096",
      title: "大厅周饰·金币价 96 折（通配·演示）",
      target: { type: "casual_shop_sku", shopSkuId: "shop_profile_flair_coin" },
      seasonId: "casual_s1",
      startsAt,
      endsAt,
      effects: { coinsCostMultiplier: 0.96 },
    },
    {
