...
export interface TournamentConfig {
    ...
    // 游戏配置
    gameType?: GameName;
    stageRuleId?: string;  // 新配置使用此字段，包含 ruleId
    isActive: boolean;
    // 参赛条件
...
export const TOURNAMENT_CONFIGS: TournamentConfig[] = [
    ...
    // Silver Tier - 关卡 1
    {
        ...
        gameType: "tacticalMonster",
        stageRuleId: "monster_rumble_challenge_silver_boss_1",
        isActive: true,
        timeRange: "permanent",
        entryRequirements: {
            isSubscribedRequired: false,
    ...
    // Silver Tier - 关卡 2
    {
        ...
        gameType: "tacticalMonster",
        stageRuleId: "monster_rumble_challenge_silver_boss_2",
        isActive: true,
        timeRange: "permanent",
        entryRequirements: {
            isSubscribedRequired: false,
    ...
    // Silver Tier - 关卡 3
    {
        ...
        gameType: "tacticalMonster",
        stageRuleId: "monster_rumble_challenge_silver_boss_3",
        isActive: true,
        timeRange: "permanent",
        entryRequirements: {
            isSubscribedRequired: false,
    ...
    // Silver Tier - 关卡 4
    {
        ...
        gameType: "tacticalMonster",
        stageRuleId: "monster_rumble_challenge_silver_boss_4",
        isActive: true,
        timeRange: "permanent",
        entryRequirements: {
            isSubscribedRequired: false,
    ...
    // Silver Tier - 关卡 5
    {
        ...
        gameType: "tacticalMonster",
        stageRuleId: "monster_rumble_challenge_silver_boss_5",
        isActive: true,
        timeRange: "permanent",
        entryRequirements: {
            isSubscribedRequired: false,
    ...
    // Gold Tier - 关卡 1
    {
        ...
        gameType: "tacticalMonster",
        stageRuleId: "monster_rumble_challenge_gold_boss_1",
        isActive: true,
        timeRange: "permanent",
        entryRequirements: {
            isSubscribedRequired: false,
    ...
    // Gold Tier - 关卡 2
    {
        ...
        gameType: "tacticalMonster",
        stageRuleId: "monster_rumble_challenge_gold_boss_2",
        isActive: true,
        timeRange: "permanent",
        entryRequirements: {
            isSubscribedRequired: false,
    ...
    // Gold Tier - 关卡 3
    {
        ...
        gameType: "tacticalMonster",
        stageRuleId: "monster_rumble_challenge_gold_boss_3",
        isActive: true,
        timeRange: "permanent",
        entryRequirements: {
            isSubscribedRequired: false,
    ...
    // Gold Tier - 关卡 4
    {
        ...
        gameType: "tacticalMonster",
        stageRuleId: "monster_rumble_challenge_gold_boss_4",
        isActive: true,
        timeRange: "permanent",
        entryRequirements: {
            isSubscribedRequired: false,
    ...
    // Gold Tier - 关卡 5
    {
        ...
        gameType: "tacticalMonster",
        stageRuleId: "monster_rumble_challenge_gold_boss_5",
        isActive: true,
        timeRange: "permanent",
        entryRequirements: {
            isSubscribedRequired: false,
    ...
    // Platinum Tier - 关卡 1
    {
        ...
        gameType: "tacticalMonster",
        stageRuleId: "monster_rumble_challenge_platinum_boss_1",
        isActive: true,
        timeRange: "permanent",
        entryRequirements: {
            isSubscribedRequired: false,
    ...
    // Platinum Tier - 关卡 2
    {
        ...
        gameType: "tacticalMonster",
        stageRuleId: "monster_rumble_challenge_platinum_boss_2",
        isActive: true,
        timeRange: "permanent",
        entryRequirements: {
            isSubscribedRequired: false,
    ...
    // Platinum Tier - 关卡 3
    {
        ...
        gameType: "tacticalMonster",
        stageRuleId: "monster_rumble_challenge_platinum_boss_3",
        isActive: true,
        timeRange: "permanent",
        entryRequirements: {
            isSubscribedRequired: false,
    ...
    // Platinum Tier - 关卡 4
    {
        ...
        gameType: "tacticalMonster",
        stageRuleId: "monster_rumble_challenge_platinum_boss_4",
        isActive: true,
        timeRange: "permanent",
        entryRequirements: {
            isSubscribedRequired: false,
    ...
    // Platinum Tier - 关卡 5
    {
        ...
        gameType: "tacticalMonster",
        stageRuleId: "monster_rumble_challenge_platinum_boss_5",
        isActive: true,
        timeRange: "permanent",
        entryRequirements: {
            isSubscribedRequired: false,
    ...
    // 示例3：Boss Rush 模式
    {
        ...
        gameType: "tacticalMonster",
        stageRuleId: "monster_rumble_boss_rush_bronze",
        isActive: true,
        timeRange: "permanent",
    ...
    // 示例4：线性关卡链（故事模式第1章第2关）
    {
        ...
        gameType: "tacticalMonster",
        stageRuleId: "monster_rumble_story_1_2",
        isActive: true,
        timeRange: "permanent",
    ...
    // 示例5：分支关卡（完成关卡1后可以选择关卡2A或2B）
    {
        ...
        gameType: "tacticalMonster",
        stageRuleId: "monster_rumble_story_1_2a",
        isActive: true,
        timeRange: "permanent",
...

    {
        ...
        gameType: "tacticalMonster",
        stageRuleId: "monster_rumble_story_1_2b",
        isActive: true,
        timeRange: "permanent",
    ...
    // 示例6：汇合关卡（需要完成2A或2B才能解锁）
    {
        ...
        gameType: "tacticalMonster",
        stageRuleId: "monster_rumble_story_1_3",
        isActive: true,
        timeRange: "permanent",
