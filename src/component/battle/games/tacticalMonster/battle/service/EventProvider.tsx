/**
 * Tactical Monster 事件提供者
 * 复用 solitaireSolo 的事件系统
 */
...
const eventCategoryMap: { [k: string]: EventCategory } = {
    "walk": EventCategory.GAME,
    "attack": EventCategory.GAME,
    "defend": EventCategory.GAME,
    "stand": EventCategory.GAME,
    "new_round": EventCategory.GAME,
    "end_round": EventCategory.GAME,
    "game_end": EventCategory.NON_BLOCK,
    "gameInit": EventCategory.GAME,
    "changeCoordDirection": EventCategory.GAME,
}
