...
export function getBronzeBoss1DynamicGuideText(
    game: { currentRound?: { turns?: Array<{ status?: number; uid?: string; skillSelect?: string; stepsUsed?: number }> } } | null,
    ...
    const turnActorId =
        turn.character_id ?? (turn as { monsterId?: string }).monsterId ?? turn.bossId ?? turn.minionId;
