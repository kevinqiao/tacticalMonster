import { InventoryModifier, Modification } from "model/RegisterModel";
...
const OrderModifier: React.FC<Props> = ({ initial, inventoryId, onUpdate }) => {
  const [modifications, setModifications] = useState<Modification[]>(initial);
  ...
  const mgroups: ModifierGroup[] = useMemo(() => {
    ...
    return mgrps;
  }, [modifierGroups, modifiers, items]);
