...
export const players = [
    ...
    },
    {
        ...
        name: "test2",
        characters: [
            { character_id: "1", attributes, level: 1, uid: "2", stats,q:6,r:2, position: { x: 6, y: 2 }, asset: "/assets/hero_elephant.png", movementRange: 2 },
            { character_id: "2", attributes, level: 1, uid: "2", stats,q:5,r:5, position: { x: 5, y: 5 }, asset: "/assets/hero_rhino.png", movementRange: 2 },
        ],
    },
];
