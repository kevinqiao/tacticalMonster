...
export const applyProvisionMerchantStaffWebLogin = internalMutation({
  args: {
    accountId: v.string(),
  ...
  handler: async (ctx, { accountId, platformUid, passwordHash, partnerId }) => {
...
export const lookupIdentitiesForMerchantTeam = authedQuery({
