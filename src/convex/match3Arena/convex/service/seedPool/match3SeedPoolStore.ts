...
export type SeedPoolEntryDoc = Doc<"match3_seed_pool_entries">;
export type RolloutSummaryDoc = Doc<"match3_seed_pool_rollout_summaries">;
...
export async function listSeedEntries(
  ...
  let q = db.query("match3_seed_pool_entries");
  if (opts.tier != null) {
