...
type MatchDoc = Doc<"portal_run_matches">;
type HumanRow = Pick<Doc<"portal_run_player_matches">, "uid" | "finishedAt" | "updatedAt">;
type BotRow = Pick<Doc<"portal_run_player_games">, "uid" | "revealAt" | "duration">;
...
export async function scheduleAsyncMatchFinalizeIfNeeded(
  ...
  if (existingJobId != null) {
    try {
      ...
      console.warn("[portal] cancel asyncMatchFinalize job", args.matchId, e);
    }
  }
