...
import { isCasualMultiplayerAsyncTemplate } from "../../../data/portalPlayerStrategyTypes";
...
export async function loadPlayerTournamentRankCounts(
  ...
  const row = await ctx.db
    .query("portal_player_tournament_rank_stats")
...
export async function incrementPlayerTournamentRankCount(
  ...
  await ctx.db.insert("portal_player_tournament_rank_stats", {
    uid: args.uid,
