...
4. **Town 叙事：** 货架主名 **Arcade League**。主场布局永久。**Town 与 Island 都是赛季 biome**（首季默认 island；镇季可用 Mayor 任期）。不要把岛或镇写成永久世界，不要用 Isle League / Mayfield 当商店名。详见 [`town-theme-narrative.md`](./town-theme-narrative.md) §11–§12。
